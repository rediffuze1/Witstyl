        ...
        >
          {services.map((service) => (
            <motion.div
              ...
              className="group relative rounded-3xl border p-6 backdrop-blur-xl transition-all"
              style={{
            ...
            >
              ...
              <div className="relative z-10">
                {service.icon && (
                  <div
                    className="inline-flex h-14 w-14 items-center justify-center rounded-2xl text-3xl mb-4"
                    style={{
